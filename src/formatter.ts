...
class OpenscadDocumentFormattingEditProvider {
    ...
    getExecutablePath() {
        const execPath = vscode.workspace.getConfiguration("openscad").get("format.executable");
    ...
    getConfigPath() {
        const configPath = vscode.workspace.getConfiguration("openscad").get("format.config");
